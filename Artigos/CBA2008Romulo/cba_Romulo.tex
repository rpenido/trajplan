...
afinação, é necessário ordenar estes pontos e gerar a trajetória
...
matriz [x,y] equivalente à imagem e para cada ponto pertencente à
trajetória é associada a informação referente à sua conectividade
e ao tipo de trajetória.

\section{Geração do programa para o robô}
Depois de montado o grafo com informações da trajetória e de
parâmetros de utilização, é necessário gerar o programa na
linguagem do robô para executar estas tarefas.

O arquivo gerado é feito baseado em um template.

Para este trabalho, foi utilizado um manipulador robótica KUKA
modelo XXXXXXXXXXXX.
